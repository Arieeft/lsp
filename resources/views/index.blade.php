...
@section('content')
    ...
    <section class="my-5 min-vh-100 d-flex flex-column justify-content-center" id="home">
        <div class="row">
            <div class="col">
                <h1>Aplikasi Pelayanan Pengaduan Masyarakat (APPM)</h1>
                <p id="quote"></p>
            </div>
        </div>
        ...
        <div class="row row-cols-auto bg-body-secondary ">
            <div class="col">
                <a class="btn btn-outline-primary rounded-0 border-0" href="#form">Form Aspirasi Pengaduan</a>
            </div>
            <div class="col">
                <a class="btn btn-outline-info rounded-0 border-0" href="#pencarian">Pencarian Laporan (by ID)</a>
            </div>
            <div class="col">
                <a class="btn btn-outline-warning rounded-0 border-0" href="#histori">Histori Aspirasi Pengaduan</a>
            </div>
        </div>
